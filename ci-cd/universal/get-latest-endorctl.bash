...
BIN_OS=linux            # choose linux, macos
BIN_ARCH=amd64          # choose amd64, arm64 -- note that not all combinations are available
SHACMD="sha256sum -c"   # change to command that will check the SHA256 checksum. on macOS this is 'shasum -a 256 -c'

# the path to save 'endorctl' to, including the name of the binary
BIN_NAME=".endorlabs/endorctl"
...
curl -o "$BIN_NAME" "https://api.endorlabs.com/download/latest/endorctl_${BIN_OS}_${BIN_ARCH}" 
